...
$sql = "SELECT * FROM booking where status='pending' and bookingtype='with_driver' ORDER BY bookingtime DESC;";
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-info" href="update-car-booking-with-driver.php?bookingid=<?php echo $row['bookingid']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
