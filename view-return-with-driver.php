...
$sql = "SELECT * FROM booking where status='confirmed' and bookingtype='with_driver' ORDER BY bookingtime DESC";
...
<div class="content-main">
    <div class="container">
        ...
        <div class="input-group">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="view-return.php" class="btn btn-outline-success">View All</a>
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="update-return-with-driver.php?bookingid=<?php echo $row['bookingid']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
