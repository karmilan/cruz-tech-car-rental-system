...
$sql = "SELECT * FROM booking where status='pending' and bookingtype='self_driving' ORDER BY bookingtime DESC;";
    ...
    <div class="container">
        <h2>Pending Inquiries</h2>
            ...
            <div class="input-group">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="view-inquiry-self-driving.php" class="btn btn-outline-success">View All</a>
