...
if (isset($_POST['update'])) {
    ...
    $extract_returndate = $_POST['extract_returndate'];

    $date1=date_create($bookingdate);
    $date2=date_create($extract_returndate);
    ...
    $hcharge=$car_hourlycharge*$hour;
    $tot=$mcharge+$dcharge+$hcharge;
    $amount = $_POST['amount'].$tot;


    $sql = "UPDATE `booking` SET `cust_drivinglicenseno`='$cust_drivinglicenseno', `bookingdate`='$bookingdate',`actual_returndate`='$actual_returndate',`extract_returndate`='$extract_returndate',`amount`='$amount',`status`='$status',`payment`='$payment' WHERE `bookingid`='$bookingid'";
        ...
        <div class="content-main">
            ...
            <div class="container container-stl">
                ...
                <form action="" method="POST">
                    ...
                    <label for="" class="form-label">Extract Return Date</label>
                    <input type="datetime-local" name="extract_returndate" class="form-control" value="<?php echo $extract_returndate; ?>"><br>
...
<input type="radio" style="padding: 10px;" class="form-check-input mt-0" name="status" value="returned">Returned
                    ...
                    <input type="text" class="form-control" name="amount" value="" hidden><br>
                            ...
                            <a type="button" class="btn btn-secondary" href="view-return.php">Vew All Booking Details >></a>
                            <br><br>
                            </fieldset>
                        </div>
                </form>
